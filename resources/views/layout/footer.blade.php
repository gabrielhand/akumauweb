<footer aria-labelledby="footer-heading">
    <div class="mx-auto px-6 py-8 bg-violet-500 text-white">
        <div class="xl:grid xl:grid-cols-2 xl:gap-10">
            <div class="flex flex-col">
                ...
                <p class="text-sm leading-6 my-8 text-footer-foreground">Nikmati pengalaman pembelian Voucher dan Top Up
                    Game otomatis kapan pun di manapun kamu mau.</p>
                <div class="flex space-x-6"><a target="_blank"
                        class="text-footer-foreground hover:text-footer-foregroundHover"
                        href="https://instagram.com/mobagems"><span class="sr-only">Instagram</span><svg
