        ...
        <div class="xl:grid xl:grid-cols-2 xl:gap-10">
            <div class="flex flex-col">
                <div class="h-14 items-center flex max-w-72">
                    <figure class="block cursor-pointer w-full h-full relative">
                        <img alt="logo" loading="lazy" decoding="async" data-nimg="fill"
                            class="object-contain object-left" sizes="(max-width: 768px) 100vw, 100px"
                            src="{{ $logo_footer }}"
                            style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                    </figure>
                </div>
                <p class="text-sm leading-6 my-8">{{ $slogan_web }}</p>
                <div class="flex space-x-6"><a target="_blank" class="" href="{{ $url_ig }}">
                        <span class="sr-only light-dark-text">Instagram</span>
